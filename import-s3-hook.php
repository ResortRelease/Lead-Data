<?php 
    ...
    function getS3($conn,$credentials,$bucket,$keyname) {
        $s3 = new S3Client([
            'version' => 'latest',
            'region'  => 'us-east-1',
